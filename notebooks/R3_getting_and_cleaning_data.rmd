...
* *I'll introduce you to resources that will show you how to:* use more advanced string functions.
...
We'll want to set our working directory inside of the notebooks folder.  I'll show you how to do that. 
...
To start, we're going to load a dataframe with info on year-by-year totals for the most popular female baby names from 2008 to 2017. I've intentionally made this very ugly. Someone needs to change this dataframe's diaper!
...
Why? Before scrolling down, see if you can figure it out. 
